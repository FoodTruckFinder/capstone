 ...
 **/
abstract class LocationTestSetup extends TestCase {
	use TestCaseTrait;
	/**
	...
	public final function getDataSet() : QueryDataSet {
		...
		//TODO Modify DataDesignTest::getDataSet() to include all the tables in your project.
	...
	//TODO Modify DataDesignTest::getConnection() to include the correct mySQL properties file.
