...
<!--TODO need to add the info and the social media links; no mas-->
		...
		<div class="card">
			...
			<ul class="p-1 list-group list-group-flush">
				...
				<li class="list-group-item">Food Truck Description:<p>f you want fresh mexican style tacos and more.<br> go to sanchez taco food trucks.
						...
						Friendly<br> service and much more. Please visit Sanchez Food Trucks listed in the locations above.</p></li>
